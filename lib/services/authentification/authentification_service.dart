...
class AuthentificationService {
  ...
  Future<bool> changePasswordForCurrentUser(
    ...
    try {
      ...
      if (oldPassword != null) {
        isOldPasswordCorrect = await verifyCurrentUserPassword(oldPassword);
      }
  ...
  Future<bool> changeEmailForCurrentUser(
    ...
    try {
      ...
      if (password != null) {
        isPasswordCorrect = await verifyCurrentUserPassword(password);
      }
  ...
  Future<bool> verifyCurrentUserPassword(String password) async {
    try {
      ...
      final UserCredential authCredentials =
          await currentUser!.reauthenticateWithCredential(authCredential);
      return authCredentials.user != null;
    } on MessagedFirebaseAuthException {
      rethrow;
    } on FirebaseAuthException catch (e) {
      switch (e.code) {
