...
final Map<ProductType, List<String>> productCategories = {
  ProductType.freshProduce: ['Fruits', 'Vegetables'],
  ProductType.grainsAndPulses: ['Cereals'],
};

final Map<String, List<String>> categoryProducts = {
  'Fruits': ['banana', 'Orange'],
  'Vegetables': ['Cauliflower', 'Onion', 'Tomato', 'Potato'],
  'Cereals': ['Paddy(Dhan)(Basmati)', 'Paddy(Dhan)(Common)', 'Wheat'],
};
...
final Map<String, List<String>> productVarieties = {
  'banana': [
    ...
    'Desi(Bontha) Banana',
    'Karpura Banana',
    'Bhushavali(Pacha) Banana',
    'Chakkarakeli(Red) Banana',
    'Amruthapani Banana',
    'Chakkarakeli(White) Banana',
  ],
  'Cauliflower': [
    'Cauliflower',
    'African Sarson Cauliflower',
  ],
  'Onion': [
    '1st Sort Onion',
    'Local Onion',
